...
import '../pages/alarm/good_morning/good_morning_page.dart' as _i13;
import '../pages/alarm/result/alarm_result_page.dart' as _i16;
...
import '../pages/alarm/set_sleep_time_details/set_sleep_time_details_page.dart'
    as _i11;
import '../pages/alarm/settings/alarm_settings_page.dart' as _i14;
import '../pages/alarm/sleeping/alarm_sleeping_page.dart' as _i15;
import '../pages/alarm/snooze/snooze_page.dart' as _i12;
import '../pages/articles/article_details_page.dart' as _i2;
import '../pages/articles/articles_page.dart' as _i18;
import '../pages/home/home_page.dart' as _i17;
...
import '../pages/statistics/all_analysis/all_analysis_page.dart' as _i10;
import '../pages/statistics/statistics_page.dart' as _i19;
...
class AppRouter extends _i20.RootStackRouter {
  ...
  final Map<String, _i20.PageFactory> pagesMap = {
    ...
    AllAnalysisRoute.name: (routeData) {
      return _i20.MaterialPageX<dynamic>(
        routeData: routeData,
        child: const _i10.AllAnalysisPage(),
      );
    },
    SetSleepTimeDetailsRoute.name: (routeData) {
      ...
      return _i20.CustomPage<dynamic>(
        routeData: routeData,
        child: _i11.SetSleepTimeDetailsPage(
          key: args.key,
    ...
    GoodMorningRoute.name: (routeData) {
      return _i20.CustomPage<dynamic>(
        routeData: routeData,
        child: const _i13.GoodMorningPage(),
        customRouteBuilder: _i22.regularPageBuilder,
        opaque: true,
        barrierDismissible: false,
      );
    ...
    AlarmSettingsRoute.name: (routeData) {
      return _i20.CustomPage<dynamic>(
        routeData: routeData,
        child: const _i14.AlarmSettingsPage(),
    ...
    AlarmSleepingRoute.name: (routeData) {
      return _i20.CustomPage<dynamic>(
        routeData: routeData,
        child: const _i15.AlarmSleepingPage(),
        customRouteBuilder: _i22.regularPageBuilder,
        opaque: true,
        barrierDismissible: false,
      );
    ...
    AlarmResultRoute.name: (routeData) {
      return _i20.CustomPage<dynamic>(
        routeData: routeData,
        child: const _i16.AlarmResultPage(),
        customRouteBuilder: _i22.regularPageBuilder,
        opaque: true,
        barrierDismissible: false,
      );
    ...
    ArticlesRoute.name: (routeData) {
      ...
      return _i20.MaterialPageX<dynamic>(
        routeData: routeData,
        child: _i18.ArticlesPage(key: args.key),
      );
    },
    StatisticsRoute.name: (routeData) {
      return _i20.MaterialPageX<dynamic>(
        routeData: routeData,
        child: const _i19.StatisticsPage(),
      );
    },
  };
...
/// generated route for
/// [_i10.AllAnalysisPage]
class AllAnalysisRoute extends _i20.PageRouteInfo<void> {
