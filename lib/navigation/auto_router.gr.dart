...
import '../pages/alarm/alarm_screen.dart' as _i6;
import '../pages/alarm/good_morning/good_morning_page.dart' as _i18;
import '../pages/alarm/result/alarm_result_page.dart' as _i21;
...
import '../pages/alarm/set_sleep_time_details/set_sleep_time_details_page.dart'
    as _i15;
import '../pages/alarm/settings/alarm_settings_page.dart' as _i19;
import '../pages/alarm/sleeping/alarm_sleeping_page.dart' as _i20;
import '../pages/alarm/snooze/snooze_page.dart' as _i16;
import '../pages/articles/article_details_page.dart' as _i5;
import '../pages/articles/articles_page.dart' as _i23;
import '../pages/home/home_page.dart' as _i22;
...
import '../pages/profile/edit_avatar/profile_settings_avatar_page.dart' as _i12;
import '../pages/profile/edit_email/profile_settings_email_page.dart' as _i11;
import '../pages/profile/edit_gender/profile_settings_gender_page.dart' as _i13;
import '../pages/profile/edit_name/profile_settings_name_page.dart' as _i9;
import '../pages/profile/edit_password/profile_settings_password.dart' as _i10;
import '../pages/profile/profile/profile_page.dart' as _i7;
import '../pages/profile/settings/profile_settings_page.dart' as _i8;
import '../pages/statistics/all_analysis/all_analysis_page.dart' as _i14;
import '../pages/statistics/current_analys/analys_widget.dart' as _i17;
import '../pages/statistics/last_analys/statistics_page.dart' as _i24;
...
class AppRouter extends _i25.RootStackRouter {
  ...
  final Map<String, _i25.PageFactory> pagesMap = {
    ...
    ExampleAlarmRingRoute.name: (routeData) {
      return _i25.MaterialPageX<dynamic>(
        routeData: routeData,
        child: const _i6.ExampleAlarmRingPage(),
      );
    },
    ...
    ProfileSettingsNameRoute.name: (routeData) {
      return _i25.MaterialPageX<dynamic>(
        routeData: routeData,
        child: const _i9.ProfileSettingsNamePage(),
      );
    },
    ProfileSettingsPasswordRoute.name: (routeData) {
      return _i25.MaterialPageX<dynamic>(
        routeData: routeData,
        child: const _i10.ProfileSettingsPasswordPage(),
      );
    },
    ProfileSettingsEmailRoute.name: (routeData) {
      return _i25.MaterialPageX<dynamic>(
        routeData: routeData,
        child: const _i11.ProfileSettingsEmailPage(),
      );
    },
    ProfileSettingsAvatarRoute.name: (routeData) {
      return _i25.MaterialPageX<dynamic>(
        routeData: routeData,
        child: const _i12.ProfileSettingsAvatarPage(),
      );
    },
    ProfileSettingsGenderRoute.name: (routeData) {
      return _i25.MaterialPageX<dynamic>(
        routeData: routeData,
        child: const _i13.ProfileSettingsGenderPage(),
      );
    },
    ...
    GoodMorningRoute.name: (routeData) {
      return _i25.CustomPage<dynamic>(
        routeData: routeData,
        child: const _i18.GoodMorningPage(),
        customRouteBuilder: _i27.regularPageBuilder,
        opaque: true,
        barrierDismissible: false,
      );
    ...
    AlarmSettingsRoute.name: (routeData) {
      return _i25.CustomPage<dynamic>(
        routeData: routeData,
        child: const _i19.AlarmSettingsPage(),
    ...
    AlarmSleepingRoute.name: (routeData) {
      return _i25.CustomPage<dynamic>(
        routeData: routeData,
        child: const _i20.AlarmSleepingPage(),
        customRouteBuilder: _i27.regularPageBuilder,
        opaque: true,
        barrierDismissible: false,
      );
    ...
    AlarmResultRoute.name: (routeData) {
      return _i25.CustomPage<dynamic>(
        routeData: routeData,
        child: const _i21.AlarmResultPage(),
        customRouteBuilder: _i27.regularPageBuilder,
        opaque: true,
        barrierDismissible: false,
      );
    ...
    ArticlesRoute.name: (routeData) {
      ...
      return _i25.MaterialPageX<dynamic>(
        routeData: routeData,
        child: _i23.ArticlesPage(key: args.key),
      );
    },
    StatisticsRoute.name: (routeData) {
      return _i25.MaterialPageX<dynamic>(
        routeData: routeData,
        child: const _i24.StatisticsPage(),
      );
    },
  };
  ...
  List<_i25.RouteConfig> get routes => [
        ...
        _i25.RouteConfig(
          ExampleAlarmRingRoute.name,
          path: '/example-alarm-ring-page',
        ),
        _i25.RouteConfig(
          ProfileRoute.name,
          path: '/profile-page',
...
/// generated route for
/// [_i6.ExampleAlarmRingPage]
class ExampleAlarmRingRoute extends _i25.PageRouteInfo<void> {
  const ExampleAlarmRingRoute()
      : super(
          ExampleAlarmRingRoute.name,
          path: '/example-alarm-ring-page',
        );

  static const String name = 'ExampleAlarmRingRoute';
}
...
/// generated route for
/// [_i10.ProfileSettingsPasswordPage]
...
/// generated route for
/// [_i12.ProfileSettingsAvatarPage]
...
/// generated route for
/// [_i13.ProfileSettingsGenderPage]
