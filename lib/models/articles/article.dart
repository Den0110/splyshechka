...
class Article with _$Article {
  ...
  factory Article.empty() => const Article(
        ...
        outline: "The application uses official data from \nmeteorological laboratories and \nscientific centers for climate and solar \nradiation research.",
        cardImageUrl: 'https://avatars.mds.yandex.net/get-images-cbir/1577595/pky-H10VhsET5enoUdIt5g3903/ocr',
      );
}
